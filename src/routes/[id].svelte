...
<script lang="ts">
    ...
    let deadline: Date | null = item.deadline ? new Date(item.deadline) : null;
            ...
            <form>
                ...
                <div class="text-right">
                    <button type="button" on:click={handleSubmit} class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-2 rounded inline-flex items-center">
                        <svg class="fill-current w-4 h-4 text-lime-800 mr-2 text-base" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 221 221" style="enable-background:new 0 0 221 221;" xml:space="preserve">
                            <g>
